...
import { Layer } from "~/views/DesignEditor/components/Panels/panelItems/Layers"
      ...
      <Scrollable>
        <Block padding="0 1.5rem">
          {layerObjects.map((object) => (
            <Layer key={object.id} object={object} clickHandler={editor.objects.select} actions={objActions} />
            // <Block
            //   $style={{
            //     display: "grid",
